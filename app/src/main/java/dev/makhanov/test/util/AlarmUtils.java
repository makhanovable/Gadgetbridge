...
public class AlarmUtils {
     ...
     * @return
     */
    public static dev.makhanov.test.model.Alarm createSingleShot(int index, boolean smartWakeup, boolean snooze, Calendar calendar) {
     ...
     * @return
     */
    public static Calendar toCalendar(dev.makhanov.test.model.Alarm alarm) {
