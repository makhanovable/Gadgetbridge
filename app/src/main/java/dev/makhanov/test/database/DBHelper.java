...
package dev.makhanov.test.database;
...
import dev.makhanov.test.entities.ActivityDescription;
import dev.makhanov.test.entities.ActivityDescriptionDao;
import dev.makhanov.test.entities.Alarm;
import dev.makhanov.test.entities.AlarmDao;
...
import dev.makhanov.test.entities.DeviceAttributesDao;
import dev.makhanov.test.entities.DeviceDao;
import dev.makhanov.test.entities.Tag;
import dev.makhanov.test.entities.TagDao;
import dev.makhanov.test.entities.User;
import dev.makhanov.test.entities.UserAttributes;
import dev.makhanov.test.entities.UserDao;
import dev.makhanov.test.impl.GBDevice;
import dev.makhanov.test.model.ActivityUser;
import dev.makhanov.test.model.ValidByDate;
