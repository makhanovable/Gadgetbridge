...
import dev.makhanov.test.database.DBOpenHelper;
import dev.makhanov.test.devices.DeviceManager;
import dev.makhanov.test.entities.DaoMaster;
import dev.makhanov.test.entities.DaoSession;
import dev.makhanov.test.entities.Device;
import dev.makhanov.test.externalevents.BluetoothStateChangeReceiver;
import dev.makhanov.test.impl.GBDevice;
import dev.makhanov.test.impl.GBDeviceService;
...
import dev.makhanov.test.service.NotificationCollectorMonitorService;
...
import static dev.makhanov.test.model.DeviceType.MIBAND;
import static dev.makhanov.test.model.DeviceType.MIBAND2;
import static dev.makhanov.test.model.DeviceType.MIBAND3;
import static dev.makhanov.test.model.DeviceType.fromKey;
