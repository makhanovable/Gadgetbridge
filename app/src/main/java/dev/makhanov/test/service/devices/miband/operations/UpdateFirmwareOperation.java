...
package dev.makhanov.test.service.devices.miband.operations;
...
import dev.makhanov.test.service.btle.actions.PlainAction;
import dev.makhanov.test.service.btle.actions.SetDeviceBusyAction;
import dev.makhanov.test.service.btle.actions.SetProgressAction;
import dev.makhanov.test.service.devices.miband.AbstractMiFirmwareInfo;
import dev.makhanov.test.service.devices.miband.MiBandSupport;
import dev.makhanov.test.service.serial.GBDeviceProtocol;
import dev.makhanov.test.util.CheckSums;
