...
import dev.makhanov.test.activities.ExternalPebbleJSActivity;
import dev.makhanov.test.activities.appmanager.AbstractAppManagerFragment;
import dev.makhanov.test.activities.appmanager.AppManagerActivity;
...
import dev.makhanov.test.devices.pebble.PBWReader;
import dev.makhanov.test.devices.pebble.PebbleInstallable;
import dev.makhanov.test.impl.GBDevice;
import dev.makhanov.test.impl.GBDeviceApp;
import dev.makhanov.test.service.devices.pebble.ble.PebbleLESupport;
import dev.makhanov.test.service.serial.GBDeviceIoThread;
...
import dev.makhanov.test.util.WebViewSingleton;
