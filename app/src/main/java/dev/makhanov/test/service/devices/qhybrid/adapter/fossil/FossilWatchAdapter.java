...
package dev.makhanov.test.service.devices.qhybrid.adapter.fossil;
...
import dev.makhanov.test.devices.qhybrid.PackageConfigHelper;
...
import dev.makhanov.test.service.devices.qhybrid.buttonconfig.ConfigFileBuilder;
import dev.makhanov.test.service.devices.qhybrid.buttonconfig.ConfigPayload;
import dev.makhanov.test.service.devices.qhybrid.requests.Request;
import dev.makhanov.test.service.devices.qhybrid.requests.fossil.FossilRequest;
...
import dev.makhanov.test.service.devices.qhybrid.requests.fossil.alarm.AlarmsSetRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.fossil.configuration.ConfigurationPutRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.fossil.file.FilePutRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.fossil.notification.NotificationFilterPutRequest;
...
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.ITEM_TIMEZONE_OFFSET;
...
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_MULTI_BUTTON_PRESS;
...
public class FossilWatchAdapter extends WatchAdapter {
    ...
    public void vibrate(dev.makhanov.test.service.devices.qhybrid.requests.misfit.PlayNotificationRequest.VibrationType vibration) {
    ...
    public void onSetAlarms(ArrayList<? extends Alarm> alarms) {
       //  throw new RuntimeException("noope");
        ArrayList<dev.makhanov.test.service.devices.qhybrid.requests.fossil.alarm.Alarm> activeAlarms = new ArrayList<>();
        for (Alarm alarm : alarms){
            if(!alarm.getEnabled()) continue;
            if(alarm.getRepetition() == 0){
                activeAlarms.add(new dev.makhanov.test.service.devices.qhybrid.requests.fossil.alarm.Alarm(
        ...
        queueWrite(new AlarmsSetRequest(activeAlarms.toArray(new dev.makhanov.test.service.devices.qhybrid.requests.fossil.alarm.Alarm[0]), this){
            @Override
            public void onFilePut(boolean success) {
                super.onFilePut(success);
