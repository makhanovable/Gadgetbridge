...
package dev.makhanov.test.service.devices.qhybrid.adapter.misfit;
...
import dev.makhanov.test.devices.DeviceManager;
import dev.makhanov.test.devices.qhybrid.NotificationConfiguration;
import dev.makhanov.test.impl.GBDevice;
import dev.makhanov.test.model.Alarm;
import dev.makhanov.test.model.BatteryState;
import dev.makhanov.test.model.GenericItem;
import dev.makhanov.test.service.btle.TransactionBuilder;
import dev.makhanov.test.service.devices.qhybrid.QHybridSupport;
import dev.makhanov.test.service.devices.qhybrid.adapter.WatchAdapter;
import dev.makhanov.test.service.devices.qhybrid.requests.Request;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.ActivityPointGetRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.AnimationRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.BatteryLevelRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.DownloadFileRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.EraseFileRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.FileRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.GetCountdownSettingsRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.GetCurrentStepCountRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.GetStepGoalRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.GetVibrationStrengthRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.GoalTrackingGetRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.ListFilesRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.MoveHandsRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.OTAEnterRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.OTAEraseRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.PlayNotificationRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.ReleaseHandsControlRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.RequestHandControlRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.SetCurrentStepCountRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.SetStepGoalRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.SetTimeRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.SetVibrationStrengthRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.UploadFileRequest;
import dev.makhanov.test.service.devices.qhybrid.requests.misfit.VibrateRequest;
import dev.makhanov.test.util.FileUtils;
import dev.makhanov.test.util.GB;

import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.ITEM_ACTIVITY_POINT;
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.ITEM_STEP_COUNT;
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.ITEM_STEP_GOAL;
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.ITEM_VIBRATION_STRENGTH;
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_BUTTON_PRESS;
import static dev.makhanov.test.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_FILE_UPLOADED;
