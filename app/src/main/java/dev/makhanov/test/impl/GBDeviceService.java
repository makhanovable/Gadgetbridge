...
package dev.makhanov.test.impl;
...
import dev.makhanov.test.util.LanguageUtils;
import dev.makhanov.test.util.RtlUtils;

import static dev.makhanov.test.util.JavaExtensions.coalesce;
