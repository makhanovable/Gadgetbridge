...
package dev.makhanov.test.devices.huami;
...
import dev.makhanov.test.devices.AbstractDeviceCoordinator;
...
import dev.makhanov.test.devices.miband.MiBandPairingActivity;
import dev.makhanov.test.devices.miband.MiBandService;
import dev.makhanov.test.entities.AbstractActivitySample;
import dev.makhanov.test.entities.DaoSession;
import dev.makhanov.test.entities.Device;
import dev.makhanov.test.entities.MiBandActivitySampleDao;
