...
package dev.makhanov.test.devices.miband;
...
import dev.makhanov.test.activities.AbstractSettingsActivity;
...
import static dev.makhanov.test.devices.miband.MiBandConst.ORIGIN_ALARM_CLOCK;
import static dev.makhanov.test.devices.miband.MiBandConst.ORIGIN_INCOMING_CALL;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_GOAL_NOTIFICATION;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS_DND;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS_DND_END;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS_DND_START;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS_END;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS_START;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MI2_INACTIVITY_WARNINGS_THRESHOLD;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MIBAND_ADDRESS;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_MIBAND_USE_HR_FOR_SLEEP_DETECTION;
import static dev.makhanov.test.devices.miband.MiBandConst.PREF_USER_ALIAS;
import static dev.makhanov.test.devices.miband.MiBandConst.VIBRATION_COUNT;
import static dev.makhanov.test.devices.miband.MiBandConst.getNotificationPrefKey;
