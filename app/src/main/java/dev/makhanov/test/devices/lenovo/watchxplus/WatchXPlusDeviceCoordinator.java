package dev.makhanov.test.devices.lenovo.watchxplus;
...
import dev.makhanov.test.devices.InstallHandler;
import dev.makhanov.test.devices.SampleProvider;
import dev.makhanov.test.devices.lenovo.LenovoWatchCalibrationActivity;
import dev.makhanov.test.devices.lenovo.LenovoWatchPairingActivity;
...
import dev.makhanov.test.service.devices.lenovo.watchxplus.WatchXPlusDeviceSupport;
import dev.makhanov.test.util.Prefs;

import static dev.makhanov.test.GBApplication.getContext;
