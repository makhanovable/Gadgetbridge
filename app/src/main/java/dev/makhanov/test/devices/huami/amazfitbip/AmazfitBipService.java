...
package dev.makhanov.test.devices.huami.amazfitbip;

import java.util.UUID;

import static dev.makhanov.test.devices.huami.HuamiService.DISPLAY_ITEM_BIT_CLOCK;
import static dev.makhanov.test.devices.huami.HuamiService.ENDPOINT_DISPLAY;
import static dev.makhanov.test.devices.huami.HuamiService.ENDPOINT_DISPLAY_ITEMS;
